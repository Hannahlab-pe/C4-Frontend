...
export default function Header() {
  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between gap-3 px-4 md:px-6 shrink-0">
      <div className="flex items-center gap-2 min-w-0">
        {/* Hamburguesa — abre el drawer en mobile */}
        <button
          onClick={toggleMobileNav}
          className="md:hidden -ml-1 w-9 h-9 rounded-lg flex items-center justify-center text-slate-600 hover:bg-slate-100 transition-colors shrink-0"
          title="Menú"
        >
      ...
      <div className="flex items-center gap-2 md:gap-3 shrink-0">
        <div className="hidden lg:flex items-center gap-2 bg-slate-100 rounded-xl px-3 py-2 w-56">
        ...
        <button className="relative w-8 h-8 rounded-xl bg-slate-100 flex items-center justify-center hover:bg-slate-200 transition-colors shrink-0">
