    ...
    <div className="h-full overflow-y-auto">
      ...
      <div className="bg-white border-b border-slate-200 px-4 md:px-6 py-4 md:py-5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center shrink-0"><Users className="w-5 h-5 text-slate-500" /></div>
          <div className="min-w-0">
            <h2 className="text-base font-bold text-slate-900 font-display">Equipo del proyecto</h2>
